...
class Road:
    ...
    def create_roads(self):
        segments = self.create_segments(50)
        self.segments.extend(segments)

        segments[0].color_road = arcade.color.PURPLE
        segments[-2].color_road = arcade.color.PINK         # last segment is end of the road
    ...
    def render3d(self, camera):
        ...
        for i in range(len(self.segments)):
            ...
            p1 = self.project3d(current_segment, camera)
            p2 = self.project3d(next_segment, camera)
